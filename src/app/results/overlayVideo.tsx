...
import { calculateAngles, drawResults, kp } from "../utilities/canvas";
...
function OverlayVideo(props: Props) {
  ...
  return (
    <div className="">
      <video
        ...
        onEnded={() => {
          setIsPlaying(false);
          store.videoData[props.index] = poseData;
        }}
        onSeeked={doTheThing}
      />
...
export default observer(OverlayVideo);
